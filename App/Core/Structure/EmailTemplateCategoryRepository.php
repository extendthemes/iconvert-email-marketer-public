...
class EmailTemplateCategoryRepository {
	use IsSingleton;
	private $api_endpoint = 'categories';
	private $slug         = 'icem-mail-tpl-cat';
    const ALL_TRANSIENT_KEY = 'iconvertem-all-templates-category';
	...
	public function all() {
		...
		$api      = new APIBase( 'categories/list' );
