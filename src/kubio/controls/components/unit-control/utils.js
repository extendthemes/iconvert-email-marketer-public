...
export const CSS_UNITS = [
	{ value: 'px', label: 'px', default: 0, a11yLabel: __('pixels', 'kubio') },
	{ value: '%', label: '%', default: 10, a11yLabel: __('percent', 'kubio') },
	{
		value: 'em',
		label: 'em',
		default: 0,
		a11yLabel: _x('ems', 'Relative to parent font size (em)', 'kubio'),
	},
	{
		value: 'rem',
		label: 'rem',
		default: 0,
		a11yLabel: _x('rems', 'Relative to root font size (rem)', 'kubio'),
	},
	{
		value: 'vw',
		label: 'vw',
		default: 10,
		a11yLabel: __('viewport widths', 'kubio'),
	},
	{
		value: 'vh',
		label: 'vh',
		default: 10,
		a11yLabel: __('viewport heights', 'kubio'),
	},
];
