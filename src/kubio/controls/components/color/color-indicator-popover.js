...
const IndicatorPopover = ({
	...
	return (
		<div className={'kubio-color-popover-wrapper'}>
			<Button ref={buttonRef} className={'kubio-color-popover-button'}>
				<ColorIndicator value={currentColor} />
			</Button>

			<KubioPopup
				className={classnames('kubio-color-popover', 'kubio-control')}
				buttonRef={buttonRef}
				anchorRef={buttonRef}
			>
				<GutentagColorPicker
			...
			{label && (
				...
				>
					<div className={'kubio-color-popover-labeled'}>
						<div className={'kubio-color-popover-label'}>
							{label}
						</div>
						<IndicatorPopover
							alpha={alpha}
