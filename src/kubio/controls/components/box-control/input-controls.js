...
export default function BoxInputControls({
	...
	return (
		<LayoutContainer className="component-box-control__input-controls-wrapper kubio-box-control-unlinked">
			<Layout gap={0} className="component-box-control__input-controls">
				<UnitControl
					{...props}
					isFirst
					value={top}
