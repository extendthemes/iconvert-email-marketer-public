			...
			<defs>
				<style
					dangerouslySetInnerHTML={{
						__html: '.cls-1-custom-stmp-icon{fill:#ccc;fill-rule:evenodd}',
					}}
				></style>
			</defs>
